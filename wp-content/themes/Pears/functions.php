...
function pears_meta_box( $post ) {
	...
	echo '<label for="css">LESS</label>	';
  	echo '<p><textarea id="css" name="css" rows="20" cols="90" />' . $css . '</textarea></p>';
  	echo '<label for="lessfile">LESS File URL (Please add the filename here and upload into <strong>/wp-uploads/less/modules/</strong> in the File Manager)</label>	';
  	echo '<p><input id="lessfile" style="border: 1px solid #ccc;width:100%" name="lessfile" value="'.$less.'"></p>';
}
