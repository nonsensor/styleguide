...
<?php $key="html"; echo get_post_meta($post->ID, $key, true); ?>
		...
		<div class="group">
			<div id="markup" class="mod">
				<h3 class="label">HTML</h3> <a href="#" class="clip copytext" title="select code for copying"><img src="<?php bloginfo('template_directory'); ?>/images/icon-copy.png" alt="copy" /></a>
				<textarea class="mod-ta"><?php $key="html"; echo get_post_meta($post->ID, $key, true); ?></textarea>
			</div>
			
			<div id="style" class="mod">
				<h3 class="label">LESS</h3> <a href="/wp-content/uploads/less/modules/<?php echo get_post_meta($post->ID, 'less', true); ?>" class="clip">Download</a> <a href="#" class="clip copytext" title="select code for copying"><img src="<?php bloginfo('template_directory'); ?>/images/icon-copy.png" alt="copy" /></a>
